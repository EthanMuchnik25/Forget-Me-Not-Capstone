...
class_name = ('backpack', 'bed', 'bicycle', 'book', 'bottle', 'bowl', 'box', 'bus', 'car', 'card', 'cell phone', 'chair', 'couch', 'cup', 'dining table', 'earbuds', 'glasses', 'handbag', 'keyboard', 'keys', 'lamp', 'laptop', 'marker', 'mouse', 'pen', 'pencil', 'person', 'pillow', 'remote', 'scissors', 'shoes', 'spoon', 'tablet', 'tape', 'toilet paper', 'trash can', 'truck', 'tv', 'wallet')
